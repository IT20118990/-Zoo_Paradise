...
public class MainActivity extends AppCompatActivity implements CourseRVAdapter.CourseClickInterface {
    ...
    private void displayBottomSheet(CourseRVModal modal) {
        ...
        TextView cardDescTV = layout.findViewById(R.id.idTVCardDesc);
        TextView suitedForTV = layout.findViewById(R.id.idTVSuitedFor);
        TextView priceTV = layout.findViewById(R.id.idTVCardPrice);
        ImageView cardIV = layout.findViewById(R.id.idIVCard);
        // on below line we are setting data to different views on below line.
        cardNameTV.setText(modal.getCardName());
        cardDescTV.setText(modal.getCardDescription());
        suitedForTV.setText("" + modal.getBestCardSuitedFor());
        priceTV.setText("Rs." + modal.getCardPrice());
        Picasso.get().load(modal.getCardImg()).into(cardIV);
        ...
        viewBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.setData(Uri.parse(modal.getCardLink()));
                startActivity(i);
            }
        });
    }
