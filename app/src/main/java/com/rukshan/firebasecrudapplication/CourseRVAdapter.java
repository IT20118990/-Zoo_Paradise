...
public class CourseRVAdapter extends RecyclerView.Adapter<CourseRVAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CourseRVAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.courseTV.setText(courseRVModal.getCardName());
        holder.coursePriceTV.setText("Rs. " + courseRVModal.getCardPrice());
        Picasso.get().load(courseRVModal.getCardImg()).into(holder.courseIV);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            courseIV = itemView.findViewById(R.id.idIVCard);
            courseTV = itemView.findViewById(R.id.idTVCardName);
            coursePriceTV = itemView.findViewById(R.id.idTVCardPrice);
        }
    }
